		  		...
		  		<div class="card-body">
					<form action="<?=cn($module)?>">
		  			<div class="table-filter">
						<div class="bg-info"><b>Info:</b> Saldo adalah saldo setelah pengajuan withdraw.</div>
		                    ...
		                    <tr>
		                    	...
		                    	<td>
		                        	<div class="btn-group btn-group-option <?=($key + 1 == count($result)?"dropup":"")?>">
									  	<a class="btn btn-default actionItem" href="<?=cn($module."/ajax_delete_item")?>" data-id="<?=$row->id?>" data-redirect="<?=cn($module)?>" data-confirm="<?=lang("are_you_sure_want_delete_it")?>" class="actionItem"><i class="fa fa-trash-o"></i></a>
									</div>
		                        </td>
