<div class="paypal-method">
    <img src="<?=BASE?>assets/img/paypal.svg">
    <a href="<?=cn('payment/paypal/process/'.$package->ids)?>" class="btn btn-dark btn-lg btn-block mt15 btnPaypalPayment"><?=lang('submit_payment')?></a>
</div>	
