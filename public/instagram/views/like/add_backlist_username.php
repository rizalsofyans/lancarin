    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-title"><i class="ft-user"></i> <?=lang('Add_usernames_blacklist')?></div>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary actionAddUsernameBlacklist"><?=lang('add')?></button>
