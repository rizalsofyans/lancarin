    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-title"><i class="ft-message-circle"></i> <?=lang('welcomedm')?></div>
            </div>
            <div class="modal-body m15">
                <div class="row">
                    <div class="col-sm-12">
						...
						<textarea class="form-control post-message textarea-welcomedm" rows="5"></textarea>                    
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary actionAddWelcomeDM"><?=lang('add')?></button>
