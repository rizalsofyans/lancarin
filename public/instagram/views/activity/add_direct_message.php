                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="small" style="padding-left: 20px; padding-top: 10px;">
                            <li style="list-style: disc outside;">Anda juga dapat menggunakan format pada DM :<br><strong>{{username}}</strong> Username Target<br/><strong>{{full_name}}</strong> Nama Instagram Target<br><br><b>Contoh Penggunaan Format dan Spintax :</b> Halo {{username}}, kami akan memberikan info {menarik|bagus|bahagia} untuk {{full_name}} berupa {diskon|potongan harga} sebesar 10% untuk pembalanjaan minimal Rp500.000 di olshop kami.
                            </li>
                        </ul>                 
                    </div>
                </div>
