		...
		<div class="card">
			<div class="card-header">
				<div class="card-title">
					<i class="fa fa-retweet" aria-hidden="true"></i> <?=$module_name;?> HISTORY
				</div>
					...
					<div class="row">
						<div class="col-md-9 col-sm-6 mb-mobile-15">
							<div class="btn-group" role="group" aria-label="export">
								<a href="<?=cn($module."/form")?>" class="btn btn-default"><i class="fa fa-edit"></i> Add Auto Post</a>
						...
						<tr>
							...
							<td>
								<div class="btn-group btn-group-option <?=($key + 1 == count($result)?"dropup":"")?>">
									<a href="<?=cn($module."/form?id={$row->id}")?>" data-toggle="tooltip"  title="Edit" class="btn btn-default "><i class="fa fa-edit"></i></a>
									<div class="btn-group">
