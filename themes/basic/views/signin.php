    ...
    <div class="oauth-wrap">
        ...
        <div class="oauth-form">
            <ul class="nav nav-tabs">
                ...
                <li><a href="<?=PATH."auth/signup"?>">  <?=lang('signup')?></a></li>
                <?php }?>
            </ul>
                ...
                <div class="tab-pane fade in active">
                    <form action="<?=cn('auth/ajax_login')?>" data-redirect="<?=get("redirect")?cn(get("redirect")):cn('dashboard')?>" class="actionForm" method="POST">
                        ...
                        <div class="checkbox">
                            ...
                            <label class="pull-right"><a href="<?=PATH."auth/forgot_password"?>"> <?=lang('forgot_password')?></a></label>
                        </div>
                    ...
                    <div class="oauth-social mt15 <?=($count_login != 0)?"pb15":"";?>">
                        ...
                        <div class="item col-md-<?=$count_login?> col-xs-<?=$count_login?> col-sm-<?=$count_login?>">
                            <a href="<?=PATH."auth/facebook"?>" class="btn btn-default btn-block"><i class="fa fa-facebook" aria-hidden="true"></i> <?=lang('facebook')?> </a>
                        </div>
                        <?php }?>
                        <?php if($google_login){?>
                        <div class="item col-md-<?=$count_login?> col-xs-<?=$count_login?> col-sm-<?=$count_login?>">
                            <a href="<?=PATH."auth/google"?>" class="btn btn-default btn-block"><i class="fa fa-google" aria-hidden="true"></i> <?=lang('google')?> </a>
                        </div>
                        <?php }?>
                        <?php if($twitter_login){?>
                        <div class="item col-md-<?=$count_login?> col-xs-<?=$count_login?> col-sm-<?=$count_login?>">
                            <a href="<?=PATH."auth/twitter_oauth"?>" class="btn btn-default btn-block"><i class="fa fa-twitter" aria-hidden="true"></i> <?=lang('twitter')?> </a>
                        </div>
                        <?php }?>
