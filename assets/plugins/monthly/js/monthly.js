		...
		function setMonthly(month, year) {
			...
			for(var dayNumber = 1; dayNumber <= dayQty; dayNumber++) {
				...
				var isInPast = options.stylePast && (
					...
					innerMarkup = '<div class="schedule-old" data-day="'+year+"/"+month+"/"+dayNumber+'"><div class="schedule-old-list schedule-old-scrollbar scrollbar-dynamic"></div><a href="javascript:void(0);" class="schedule-old-open"><i class="ft-check-circle success iopen" data-toggle="tooltip" data-placement="left" title="" data-original-title="'+lang.complete+'"></i><i class="ft-x danger iclose"></i></a></div>';
				...
				if(options.mode === "event") {
					...
					$(parent + " .monthly-day-wrap").append("<div"
						...
						+ ">" + innerMarkup + "<span class='monthly-day-name'>" + dayNames[thisDate.getDay()] + "</span>" + "</div>");
