   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 ...
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<div class="dtp-close"><a href="javascript:void(0);"><i class="fa fa-times"></i></a></div>' +
                         '</header>' +
              ...
              initHours: function ()
              {
                 ...
                 for (var i = 0; i < 12; i++)
                 {
                    ...
                    var fill = ((this.currentDate.format(hFormat) == i) ? "#00B5B8" : 'transparent');
                 ...
                 if (!this.params.shortTime)
                 {
                    for (var i = 0; i < 12; i++)
                    {
                       ...
                       var fill = ((this.currentDate.format(hFormat) == (i + 12)) ? "#00B5B8" : 'transparent');
              ...
              initMinutes: function ()
              {
                 ...
                 for (var i = 0; i < 60; i++)
                 {
                    ...
                    var color = ((this.currentDate.format("m") == i) ? "#00B5B8" : 'transparent');
              ...
              createSVGClock: function (isHour)
              {
                 ...
                 if (isHour)
                 {
                    ...
                    var svgHourHand = this.createSVGElement("line", {class: 'hour-hand', x1: 0, y1: 0, x2: 0, y2: hl, stroke: '#00B5B8', 'stroke-width': 8});

                    svgGElement.appendChild(svgMinuteHand);
                    svgGElement.appendChild(svgHourHand);
                 } else
                 {
                    var svgMinuteHand = this.createSVGElement("line", {class: 'minute-hand', x1: 0, y1: 0, x2: 0, y2: -150, stroke: '#00B5B8', 'stroke-width': 2});
              ...
              _onSelectHour: function (e)
              {
                 if (!$(e.target).hasClass('disabled'))
                 {
                    ...
                    $(parent.find('#h-' + value)).attr('fill', '#00B5B8');
              ...
              _onSelectMinute: function (e)
              {
                 if (!$(e.target).hasClass('disabled'))
                 {
                    ...
                    $(parent.find('#m-' + value)).attr('fill', '#00B5B8');
