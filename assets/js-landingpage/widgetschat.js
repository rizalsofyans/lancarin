    ...
    function init() {
        ...
        $('.keyreply-chat-icon, .keyreply-overlay-chat-icon').each(function(index, icon) {
            ...
            switch (app.data('type')) {
                ...
                case 'whatsapp':
                  if (Mobile) {
                    link = 'whatsapp://send/?phone=' + '+62' + '&text=' + encodeURIComponent(settings.message || "Halo Kak, aku mau tanya mengenai Lancarin")
                  } else {
                    link = 'https://web.whatsapp.com/send?phone=' + '+62' + '&text=' + encodeURIComponent(settings.message || "Halo Kak, aku mau tanya mengenai Lancarin")
                  }
                    break;
